...
import {RacaCorModel} from 'src/app/shared/models/raca-cor.model';

@Component({
    selector: 'app-edit-raca-cor-modal',
    templateUrl: './edit-raca-cor-modal.component.html',
    styleUrls: ['./edit-raca-cor-modal.component.scss'],
    providers: [
        {provide: NgbDateAdapter, useClass: CustomAdapter},
        {provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter}
    ]
})
export class EditRacaCorModalComponent implements OnInit, OnDestroy {
    @Input() id: number | string;
    private EMPTY_ENTITY: RacaCorModel;
    isLoading$;
    entity: RacaCorModel;
    formGroup: FormGroup;
    entityName = 'Raça/Cor';
    ...
    constructor(
        private entityService: RacaCorService,
        private fb: FormBuilder, public modal: NgbActiveModal
    ) {
    }

    ngOnInit(): void {
        this.EMPTY_ENTITY = new RacaCorModel();
