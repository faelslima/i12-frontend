...
import {EstadoCivilModel} from '../../../../../shared/models/estado-civil.model';
import {EstadoCivilService} from '../../../../../shared/service/estado-civil.service';

@Component({
    selector: 'app-edit-estado-civil-modal',
    templateUrl: './edit-estado-civil-modal.component.html',
    styleUrls: ['./edit-estado-civil-modal.component.scss'],
    providers: [
        {provide: NgbDateAdapter, useClass: CustomAdapter},
        {provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter}
    ]
})
export class EditEstadoCivilModalComponent implements OnInit, OnDestroy {
    @Input() id: number | string;
    isLoading$;
    private EMPTY_ENTITY: EstadoCivilModel;
    entity: EstadoCivilModel;
    formGroup: FormGroup;
    entityName = 'Estado Civil';
    private subscriptions: Subscription[] = [];

    constructor(
        private entityService: EstadoCivilService,
        private fb: FormBuilder, public modal: NgbActiveModal
    ) {
    }

    ngOnInit(): void {
        this.EMPTY_ENTITY = new EstadoCivilModel();
    ...
    private loadEntity() {
        if (!this.id) {
            ...
            ).subscribe((object: EstadoCivilModel) => {
                this.entity = object;
                this.loadForm();
            });
    ...
    create() {
        ...
        ).subscribe((res: EstadoCivilModel) => {
            this.entity = res;
            Swal.fire({
